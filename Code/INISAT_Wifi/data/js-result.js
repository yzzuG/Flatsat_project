...
if (!!window.EventSource) {
    ...
    //console.log(consConf);
     ...
     //console.log("CAP_readings", e.data);
      ...
      filetxt = filetxt + Number(incrementation)+" "+Number(obj.var1).toFixed(3)+" "+Number(obj.var4).toFixed(3)+" "+Number(obj.var6).toFixed(3)+" "+Number(obj.var7).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var8).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var9).toFixed(3);
      ...
      console.log('%cPression (Pa) : %cPr = %s.', 'color: blue; font-size: 12px','', Number(obj.var10).toFixed(3));
      filetxt = filetxt + " "+Number(obj.var10).toFixed(3);
      var titre = "Pression (Pa): ";
      ...
      filetxt = filetxt + " "+Number(obj.var11).toFixed(3)+" "+Number(obj.var12).toFixed(3)+" "+Number(obj.var13).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var14).toFixed(3)+" "+Number(obj.var15).toFixed(3)+" "+Number(obj.var16).toFixed(3)+" "+Number(obj.var17).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var18).toFixed(3)+" "+Number(obj.var19).toFixed(3)+" "+Number(obj.var20).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var21).toFixed(3)+" "+Number(obj.var22).toFixed(3)+" "+Number(obj.var23).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var24).toFixed(3)+" "+Number(obj.var25).toFixed(3)+" "+Number(obj.var26).toFixed(3);
      ...
      filetxt = filetxt + " "+Number(obj.var30).toFixed(3)+" "+Number(obj.var31).toFixed(3)+" "+Number(obj.var32).toFixed(3);
     ...
     // console.log('X = %s, Y = %s, Z = %s.', Number(obj.var30).toFixed(3), Number(obj.var31).toFixed(3), Number(obj.var32).toFixed(3)); }
      ...
      filetxt = filetxt + " "+Number(obj.var33).toFixed(3)+" "+Number(obj.var34).toFixed(3)+" "+Number(obj.var35).toFixed(3)+" "+Number(obj.var36).toFixed(3)+" "+Number(obj.var37).toFixed(3);
      var titre = "Luminance : ";
      ...
      var lat=obj.var39.slice(0,-1);
      var long = obj.var40.slice(0,-1);
      filetxt = filetxt + " "+lat+" "+long+" "+obj.var41;
